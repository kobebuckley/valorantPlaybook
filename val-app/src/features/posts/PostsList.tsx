...
import { db, auth } from '../../firebase/firebase-config'; // Import the Firestore and Auth instances
...
export const PostsList: React.FC<Props> = ({ posts }) => {
  const [user, setUser] = useState<any>(null); // Use 'user' instead of 'loggedInUser'

  useEffect(() => {
    // Set the user using Firebase Auth
